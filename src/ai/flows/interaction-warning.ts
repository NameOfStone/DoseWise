...
وظایف شما:
۱. محاسبه بازه دوز: بر اساس وزن بیمار و دستورالعمل‌ها، بازه دوز دارو را (از کران پایین تا کران بالا) در واحد میلی‌گرم برای هر نوبت مصرف محاسبه کن. نتیجه باید یک بازه متنی باشد (مثلا: '۱۴۰ الی ۲۱۰ میلی‌گرم').
۲. محاسبه بازه حجم: بر اساس بازه دوز محاسبه شده و غلظت شربت، بازه حجم مورد نیاز از شربت را در واحد میلی‌لیتر برای هر نوبت مصرف محاسبه کن. نتیجه باید یک بازه متنی باشد (مثلا: '۴.۴ الی ۶.۶ میلی‌لیتر').
