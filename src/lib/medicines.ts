export const medicineLibrary = [
  {
    ...
    concentrations: ["۱۶۰ میلی‌گرم / ۵ میلی‌لیتر"],
  },
  {
    name: "Ibuprofen",
    ...
    concentrations: ["۱۰۰ میلی‌گرم / ۵ میلی‌لیتر"],
  },
  {
    name: "Amoxicillin",
    ...
    concentrations: ["۱۲۵ میلی‌گرم / ۵ میلی‌لیتر", "۲۰۰ میلی‌گرم / ۵ میلی‌لیتر", "۲۵۰ میلی‌گرم / ۵ میلی‌لیتر", "۴۰۰ میلی‌گرم / ۵ میلی‌لیتر"],
  },
  {
    name: "Cetirizine",
    guidelines: "کودکان ۲ تا ۵ سال: ۲.۵ میلی‌گرم یک بار در روز. کودکان بالای ۶ سال و بزرگسالان: ۵ تا ۱۰ میلی‌گرم یک بار در روز.",
    concentrations: ["۵ میلی‌گرم / ۵ میلی‌لیتر"],
  },
];
